...
C2_deltaIB = FB_L(2);
C2_deltaIC = FC_L(2);
delta_ddAz = (1/masseTotal)*[C2_deltaAx C2_deltaAy C2_deltaZ C2_deltaIA C2_deltaIB C2_deltaIC];
...
delta_ddAx = (1/inertieP)*[C3_deltaAx C3_deltaAy C3_deltaZ C3_deltaPx C3_deltaIB C3_deltaIC];
...
delta_ddAy = (-1/inertieP)*[C4_deltaAx C4_deltaAy C4_deltaZ C4_deltaPy C4_deltaIA C4_deltaIB C4_deltaIC];
